...
namespace WeightlessCore.Simulation
{
    public class RigidCuboid
    {
        #region Constants

        private const int TimestepCount = 20;

        public const float ReactionForceMultiplier = 100;
        public const float FrictionForceMultiplier = 2;
        ...
        {
            float dt = timeDelta/TimestepCount;
